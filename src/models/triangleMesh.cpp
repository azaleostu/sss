...
namespace M3D_ISICG
{
	...
	void TriangleMesh::render( const GLuint p_glProgram ) const
	{
		...
		glProgramUniform3fv(
			p_glProgram, glGetUniformLocation( p_glProgram, "uAmbiant" ), 1, glm::value_ptr( _material._ambient ) );
		glProgramUniform3fv(
		...
		glProgramUniform1i( p_glProgram, glGetUniformLocation( p_glProgram, "uIsLiquid" ), _material._liquid );
